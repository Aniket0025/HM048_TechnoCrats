...
echo "========================================"
echo "AI Attendance Analytics - Complete Analysis"
echo "========================================"
echo
...
if [ ! -f "models/isolation_forest.pkl" ]; then
    ...
    echo "Please run train_model.sh first to train the model."
    exit 1
fi

# Check if data exists
if [ ! -f "data/attendance_data.xlsx" ]; then
...
echo "Starting complete attendance analysis..."
echo
...
echo "• attendance_predictions.xlsx (Excel file with predictions)"
echo "• attendance_report.html (Interactive HTML report)"
echo
echo "Open the HTML report in your browser to view the complete analysis!"
echo
echo "To open the report (if on macOS):"
echo "open outputs/attendance_report.html"
echo
echo "To open the report (if on Linux):"
echo "xdg-open outputs/attendance_report.html"
echo
